...
import com.tiklab.postlink.client.model.ApiMethodMeta;
import com.tiklab.postlink.client.parser.ApiParser;
...
public class PostLinkBuilder {
    ...
    private static Logger logger = LoggerFactory.getLogger(PostLinkBuilder.class);
    ...
    public PostLinkBuilder scan(String scanPackage) {
        this.scanPackage = scanPackage;
        return this;
    }

    public PostLinkBuilder docPath(String docPath) {
