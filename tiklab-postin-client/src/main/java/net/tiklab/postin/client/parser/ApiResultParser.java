package net.tiklab.postin.client.parser;

import com.alibaba.fastjson.JSON;
import net.tiklab.core.exception.SystemException;
import net.tiklab.postin.client.mock.JMockitForGeneric;
import net.tiklab.postin.client.model.ApiResultMeta;
import net.tiklab.postin.client.model.TypeMetaEnum;
