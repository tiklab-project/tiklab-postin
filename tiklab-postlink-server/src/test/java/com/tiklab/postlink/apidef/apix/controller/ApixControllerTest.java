package com.tiklab.postlink.apidef.apix.controller;
...
public class ApixControllerTest {

    private static Logger logger = LoggerFactory.getLogger(ApixControllerTest.class);
    ...
    public void test01ForSaveBasedef() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(apix));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/apix/createApix")
