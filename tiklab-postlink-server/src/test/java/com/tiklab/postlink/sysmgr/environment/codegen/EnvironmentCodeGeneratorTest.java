package com.tiklab.postlink.sysmgr.environment.codegen;

import com.tiklab.postlink.sysmgr.environment.entity.EnvironmentEntity;
...
public class EnvironmentCodeGeneratorTest extends CodeGeneratorTemplate {
    ...
    protected CodeGeneratorConfig getCodeGeneratorConfig() {
        ...
        config.setPkg("com.tiklab.postlink.sysmgr");
