package com.tiklab.postlink.sysmgr.datastructure.controller;
...
public class DataStructureControllerTest {

    private static Logger logger = LoggerFactory.getLogger(DataStructureControllerTest.class);
    ...
    public void test01ForSaveDataStructure() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(dataStructure);

        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/dataStructure/createDataStructure")
    ...
    public void test02ForUpdateDataStructure(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/dataStructure/updateDataStructure")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindDataStructure() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/dataStructure/findDataStructure")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllDataStructure() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/dataStructure/findAllDataStructure")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteDataStructure(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/dataStructure/deleteDataStructure")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
