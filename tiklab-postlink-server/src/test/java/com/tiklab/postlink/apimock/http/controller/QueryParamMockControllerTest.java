...
import com.tiklab.postlink.apimock.http.model.QueryParamMock;
...
public class QueryParamMockControllerTest {

    private static Logger logger = LoggerFactory.getLogger(QueryParamMockControllerTest.class);
    ...
    public void test01ForSaveQueryParamMock() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(queryParamMock);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/queryParamMock/createQueryParamMock")
    ...
    public void test02ForUpdateQueryParamMock(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/queryParamMock/updateQueryParamMock")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindQueryParamMock() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/queryParamMock/findQueryParamMock")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllQueryParamMock() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/queryParamMock/findAllQueryParamMock")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteQueryParamMock(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/queryParamMock/deleteQueryParamMock")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
