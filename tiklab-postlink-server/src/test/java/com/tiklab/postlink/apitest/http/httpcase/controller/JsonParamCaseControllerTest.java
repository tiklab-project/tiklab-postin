...
import com.tiklab.postlink.apitest.http.httpcase.model.JsonParamCase;
...
public class JsonParamCaseControllerTest {

    private static Logger logger = LoggerFactory.getLogger(JsonParamCaseControllerTest.class);
    ...
    public void test03ForFindJsonParamCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/jsonParamCase/findJsonParamCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllJsonParamCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/jsonParamCase/findAllJsonParamCase")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteJsonParamCase(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/jsonParamCase/deleteJsonParamCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
