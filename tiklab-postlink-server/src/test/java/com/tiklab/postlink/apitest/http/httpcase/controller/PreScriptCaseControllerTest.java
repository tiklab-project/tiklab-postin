...
import com.tiklab.postlink.apitest.http.httpcase.model.PreScriptCase;
...
public class PreScriptCaseControllerTest {

    private static Logger logger = LoggerFactory.getLogger(PreScriptCaseControllerTest.class);
    ...
    public void test01ForSavePreScriptCase() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(preScriptCase);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/preScriptCase/createPreScriptCase")
    ...
    public void test02ForUpdatePreScriptCase(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/preScriptCase/updatePreScriptCase")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindPreScriptCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/preScriptCase/findPreScriptCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllPreScriptCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/preScriptCase/findAllPreScriptCase")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeletePreScriptCase(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/preScriptCase/deletePreScriptCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
