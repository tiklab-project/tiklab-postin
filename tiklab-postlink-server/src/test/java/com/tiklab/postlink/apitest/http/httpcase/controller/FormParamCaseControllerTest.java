package com.tiklab.postlink.apitest.http.httpcase.controller;
...
import com.tiklab.postlink.apitest.http.httpcase.model.FormParamCase;
...
public class FormParamCaseControllerTest {

    private static Logger logger = LoggerFactory.getLogger(FormParamCaseControllerTest.class);
    ...
    public void test01ForSaveFormParamCase() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(formParamCase);

        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/formParamCase/createFormParamCase")
    ...
    public void test02ForUpdateFormParamCase(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/formParamCase/updateFormParamCase")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindFormParamCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/formParamCase/findFormParamCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllFormParamCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/formParamCase/findAllFormParamCase")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteFormParamCase(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/formParamCase/deleteFormParamCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
