...
public class HttpHttpTestcaseControllerTest {

    private static Logger logger = LoggerFactory.getLogger(HttpHttpTestcaseControllerTest.class);
    ...
    public void test01ForSaveTestcase() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(httpTestcase);
