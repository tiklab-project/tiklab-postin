package com.tiklab.postlink.apidef.apix.service;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.tiklab.postlink.apidef.apix.dao.ApixDao;
import com.tiklab.postlink.apidef.apix.entity.ApixEntity;
...
import com.tiklab.postlink.integration.dynamic.service.DynamicService;
import com.tiklab.postlink.sysmgr.support.MessageTemplateConstant;
...
import com.tiklab.message.message.model.Message;
import com.tiklab.message.message.model.MessageReceiver;
import com.tiklab.message.message.model.MessageTemplate;
import com.tiklab.message.message.service.MessageService;
...
public class ApixServiceImpl implements ApixService {
    ...
    private void sendMessageForCreate(Apix apix){
        ...
        message.setApplication("postlink");
        //设置接收人
