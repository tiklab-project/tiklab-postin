...
import com.tiklab.postlink.workspace.model.WorkspaceQuery;
...
public class WorkspaceDao{
    ...
    */
    ...
    public List<WorkspaceEntity> findWorkspaceJoinList(WorkspaceQuery workspaceQuery) {
        ...
        String sql = "select postlink_workspace.workspace_name,postlink_workspace.id,postlink_workspace.description,postlink_workspace.user_id,orc_dm_user.user_id  " +
                "from postlink_workspace,orc_dm_user " +
                "where  postlink_workspace.id = orc_dm_user.domain_id and orc_dm_user.user_id= ? ";
