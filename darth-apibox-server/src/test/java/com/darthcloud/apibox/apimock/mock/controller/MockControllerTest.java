package com.darthcloud.apibox.apimock.mock.controller;
...
public class MockControllerTest {
    ...
    private static Logger logger = LoggerFactory.getLogger(MockControllerTest.class);
