package com.darthcloud.apibox.apimock.jsonresponsemock.controller;
...
public class JsonResponseMockControllerTest {

    private static Logger logger = LoggerFactory.getLogger(JsonResponseMockControllerTest.class);
    ...
    public void test01ForSaveJsonResponseMock() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(jsonResponseMock));
