...
public class RequestParamControllerTest {
    ...
    private static Logger logger = LoggerFactory.getLogger(RequestParamControllerTest.class);
    ...
    public void test01ForSaveRequestParam() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(requestParam));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/requestParam/createRequestParam")
    ...
    public void test02ForUpdateRequestParam(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/requestParam/updateRequestParam")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindRequestParam() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/requestParam/findRequestParam")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllRequestParam() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/requestParam/findAllRequestParam")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteRequestParam(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/requestParam/deleteRequestParam")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
