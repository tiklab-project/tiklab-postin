package com.darthcloud.apibox.responseresult.dao;
...
public class ResponseResultDao{
    ...
    */
    ...
    public List<ResponseResultPo> findResponseResultList(ResponseResultQuery responseResultQuery) {
        return jpaTemplate.createCriteriaForQuery(ResponseResultPo.class).list(responseResultQuery);
    }

    public Pagination<List<ResponseResultPo>> findResponseResultPage(ResponseResultQuery responseResultQuery) { 
        return jpaTemplate.createCriteriaForQuery(ResponseResultPo.class).page(responseResultQuery);
    }
}