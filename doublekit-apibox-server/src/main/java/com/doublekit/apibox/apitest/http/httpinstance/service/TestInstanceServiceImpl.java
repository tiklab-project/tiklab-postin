...
import com.doublekit.apibox.apitest.http.httpinstance.dao.TestInstanceDao;
...
public class TestInstanceServiceImpl implements TestInstanceService {
    ...
    public String createTestInstance(@NotNull @Valid TestInstance testInstance) {
        HttpTestInstanceEntity httpTestInstanceEntity = BeanMapper.map(testInstance, HttpTestInstanceEntity.class);
        httpTestInstanceEntity.setCreateTime(new Timestamp(System.currentTimeMillis()));
        return testInstanceDao.createTestInstance(httpTestInstanceEntity);
    }
    ...
    public void updateTestInstance(@NotNull @Valid TestInstance testInstance) {
        ...
        testInstanceDao.updateTestInstance(httpTestInstanceEntity);
    }
    ...
    public TestInstance findOne(String id) {
        HttpTestInstanceEntity httpTestInstanceEntity = testInstanceDao.findTestInstance(id);

        TestInstance testInstance = BeanMapper.map(httpTestInstanceEntity, TestInstance.class);
        return testInstance;
    }

    @Override
    public List<TestInstance> findList(List<String> idList) {
        List<HttpTestInstanceEntity> httpTestInstanceEntityList =  testInstanceDao.findTestInstanceList(idList);

        List<TestInstance> testInstanceList =  BeanMapper.mapList(httpTestInstanceEntityList,TestInstance.class);
    ...
    public List<TestInstance> findAllTestInstance() {
        List<HttpTestInstanceEntity> httpTestInstanceEntityList =  testInstanceDao.findAllTestInstance();
    ...
    public List<TestInstance> findTestInstanceList(TestInstanceQuery testInstanceQuery) {
        List<HttpTestInstanceEntity> httpTestInstanceEntityList = testInstanceDao.findTestInstanceList(testInstanceQuery);
    ...
    public Pagination<TestInstance> findTestInstancePage(TestInstanceQuery testInstanceQuery) {
        ...
        Pagination<HttpTestInstanceEntity>  pagination = testInstanceDao.findTestInstancePage(testInstanceQuery);
