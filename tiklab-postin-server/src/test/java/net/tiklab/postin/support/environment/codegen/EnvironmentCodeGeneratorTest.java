package net.tiklab.postin.support.environment.codegen;

import net.tiklab.postin.support.environment.entity.EnvironmentEntity;
...
public class EnvironmentCodeGeneratorTest extends CodeGeneratorTemplate {
    ...
    protected CodeGeneratorConfig getCodeGeneratorConfig() {
        ...
        config.setPkg("net.tiklab.postin.sysmgr");
