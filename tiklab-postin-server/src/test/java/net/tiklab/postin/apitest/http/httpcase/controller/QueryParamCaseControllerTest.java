...
import net.tiklab.postin.api.http.test.httpcase.model.QueryParamCase;
...
public class QueryParamCaseControllerTest {

    private static Logger logger = LoggerFactory.getLogger(QueryParamCaseControllerTest.class);
    ...
    public void test01ForSaveQueryParamCase() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(queryParamCase);

        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/queryParamCase/createQueryParamCase")
    ...
    public void test02ForUpdateQueryParamCase(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/queryParamCase/updateQueryParamCase")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindQueryParamCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/queryParamCase/findQueryParamCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllQueryParamCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/queryParamCase/findAllQueryParamCase")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteQueryParamCase(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/queryParamCase/deleteQueryParamCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
