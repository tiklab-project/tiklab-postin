package net.tiklab.postin.integration.codegen;
...
import net.tiklab.postin.integration.share.entity.ShareEntity;
...
public class ShareCodeGeneratorTest extends CodeGeneratorTemplate {
    ...
    protected CodeGeneratorConfig getCodeGeneratorConfig() {
        ...
        config.setPkg("net.tiklab.postin.integration.share");
