...
import net.tiklab.postin.apidef.http.mock.model.FormParamMock;
...
public class FormParamMockControllerTest {

    private static Logger logger = LoggerFactory.getLogger(FormParamMockControllerTest.class);
    ...
    public void test01ForSaveFormParamMock() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(formParamMock);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/formParamMock/createFormParamMock")
    ...
    public void test02ForUpdateFormParamMock(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/formParamMock/updateFormParamMock")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindFormParamMock() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/formParamMock/findFormParamMock")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllFormParamMock() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/formParamMock/findAllFormParamMock")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteFormParamMock(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/formParamMock/deleteFormParamMock")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
