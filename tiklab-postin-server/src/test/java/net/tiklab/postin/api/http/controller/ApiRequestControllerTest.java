...
public class ApiRequestControllerTest {
    ...
    private static Logger logger = LoggerFactory.getLogger(ApiRequestControllerTest.class);
    ...
    public void test01ForSaveApiRequest() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(apiRequest));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/apiRequest/createApiRequest")
    ...
    public void test02ForUpdateApiRequest(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/apiRequest/updateApiRequest")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindApiRequest() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/apiRequest/findApiRequest")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllApiRequest() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/apiRequest/findAllApiRequest")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteApiRequest(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/apiRequest/deleteApiRequest")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
