...
import com.tiklab.postin.sysmgr.datastructure.model.EnumParam;
...
public class EnumParamControllerTest {

    private static Logger logger = LoggerFactory.getLogger(EnumParamControllerTest.class);
    ...
    public void test04ForFindAllEnumParam() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/enumParam/findAllEnumParam")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteEnumParam(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/enumParam/deleteEnumParam")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
