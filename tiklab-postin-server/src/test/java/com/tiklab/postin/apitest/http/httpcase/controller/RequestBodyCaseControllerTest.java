...
import com.tiklab.postin.apitest.http.httpcase.model.RequestBodyCase;
...
public class RequestBodyCaseControllerTest {

    private static Logger logger = LoggerFactory.getLogger(RequestBodyCaseControllerTest.class);
    ...
    public void test01ForSaveRequestBodyCase() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(requestBodyCase);

        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/requestBodyCase/createRequestBodyCase")
    ...
    public void test02ForUpdateRequestBodyCase(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/requestBodyCase/updateRequestBodyCase")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindRequestBodyCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/requestBodyCase/findRequestBodyCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllRequestBodyCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/requestBodyCase/findAllRequestBodyCase")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteRequestBodyCase(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/requestBodyCase/deleteRequestBodyCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
