package com.tiklab.postin.apitest.http.httpcase.controller;

import com.tiklab.postin.apitest.http.httpcase.model.BinaryParamCase;
...
public class BinaryParamCaseControllerTest {

    private static Logger logger = LoggerFactory.getLogger(BinaryParamCaseControllerTest.class);
    ...
    public void test01ForSaveBinaryParamCase() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(binaryParamCase);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/binaryParamCase/createBinaryParamCase")
    ...
    public void test02ForUpdateBinaryParamCase(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/binaryParamCase/updateBinaryParamCase")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindBinaryParamCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/binaryParamCase/findBinaryParamCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllBinaryParamCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/binaryParamCase/findAllBinaryParamCase")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteBinaryParamCase(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/binaryParamCase/deleteBinaryParamCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
