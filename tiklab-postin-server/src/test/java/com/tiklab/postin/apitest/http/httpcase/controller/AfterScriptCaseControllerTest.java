...
import com.tiklab.postin.apitest.http.httpcase.model.AfterScriptCase;
...
public class AfterScriptCaseControllerTest {

    private static Logger logger = LoggerFactory.getLogger(AfterScriptCaseControllerTest.class);
    ...
    public void test03ForFindAfterScriptCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/afterScriptCase/findAfterScriptCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllAfterScriptCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/afterScriptCase/findAllAfterScriptCase")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteAfterScriptCase(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/afterScriptCase/deleteAfterScriptCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
