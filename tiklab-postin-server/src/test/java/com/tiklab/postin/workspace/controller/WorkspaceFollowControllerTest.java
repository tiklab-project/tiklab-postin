...
public class WorkspaceFollowControllerTest {

    private static Logger logger = LoggerFactory.getLogger(WorkspaceFollowControllerTest.class);
    ...
    public void test01ForSaveWorkspaceFollow() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(workspaceFollow));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/workspaceFollow/createWorkspaceFollow")
    ...
    public void test02ForUpdateWorkspaceFollow(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/workspaceFollow/updateWorkspaceFollow")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindWorkspaceFollow() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/workspaceFollow/findWorkspaceFollow")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllWorkspaceFollow() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/workspaceFollow/findAllWorkspaceFollow")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteWorkspaceFollow(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/workspaceFollow/deleteWorkspaceFollow")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
