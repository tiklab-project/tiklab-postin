...
public class RequestInstancesControllerTest {

    private static Logger logger = LoggerFactory.getLogger(RequestInstancesControllerTest.class);
    ...
    public void test01ForSaveRequestInstance() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(requestInstances);
