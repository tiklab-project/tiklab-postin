...
public class ResponseInstancesControllerTest {

    private static Logger logger = LoggerFactory.getLogger(ResponseInstancesControllerTest.class);
    ...
    public void test01ForSaveResponseInstance() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(responseInstances);
