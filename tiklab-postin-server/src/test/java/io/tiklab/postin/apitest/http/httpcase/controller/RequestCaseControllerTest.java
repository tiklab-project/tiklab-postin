...
public class RequestCaseControllerTest {

    private static Logger logger = LoggerFactory.getLogger(RequestCaseControllerTest.class);
    ...
    public void test01ForSaveRequestCase() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(requestCase));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/requestCase/createRequestCase")
    ...
    public void test02ForUpdateRequestCase(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/requestCase/updateRequestCase")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindRequestCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/requestCase/findRequestCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllRequestCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/requestCase/findAllRequestCase")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteRequestCase(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/requestCase/deleteRequestCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
