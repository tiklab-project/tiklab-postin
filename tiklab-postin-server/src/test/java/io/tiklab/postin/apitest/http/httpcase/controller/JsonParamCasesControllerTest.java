...
public class JsonParamCasesControllerTest {

    private static Logger logger = LoggerFactory.getLogger(JsonParamCasesControllerTest.class);
    ...
    public void test01ForSaveJsonParamCase() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(jsonParamCases);
