...
public class AssertInstancesControllerTest {

    private static Logger logger = LoggerFactory.getLogger(AssertInstancesControllerTest.class);
    ...
    public void test01ForSaveAssertInstance() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(assertInstances);
