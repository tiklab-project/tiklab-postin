...
public class AssertCasesControllerTest {

    private static Logger logger = LoggerFactory.getLogger(AssertCasesControllerTest.class);
    ...
    public void test01ForSaveAssertCase() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(assertCases);
