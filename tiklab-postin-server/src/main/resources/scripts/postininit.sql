...
INSERT INTO `pcs_prc_role` VALUES ('postinId', 'admin', NULL, 'custom', '1', 'postin');
...
INSERT INTO `pcs_prc_role_function` (`id`, `role_id`, `function_id`, `bgroup`) VALUES ('0072401117976f6a8053b1e7b42aa6f4', 'postinId', '9bab146ee19fd1ce65d769966ebed231', 'postin');
INSERT INTO `pcs_prc_role_function` (`id`, `role_id`, `function_id`, `bgroup`) VALUES ('06c247eb47b78f48bea9f533aae1af1b', 'postinId', '5d46c6e4f019a45edef7b427db5a732a', 'postin');
INSERT INTO `pcs_prc_role_function` (`id`, `role_id`, `function_id`, `bgroup`) VALUES ('099ae3dde73676ed500a291369784a3a', 'postinId', 'df989f1ffd0ae0b542e9cb524f0534ce', 'postin');
...
INSERT INTO `pcs_prc_role_function` (`id`, `role_id`, `function_id`, `bgroup`) VALUES ('24a4cd0e5a98749d86c7bcad4603e263', 'postinId', '76608490874eed4ef820d84d114ec780', 'postin');
...
INSERT INTO `pcs_prc_role_function` (`id`, `role_id`, `function_id`, `bgroup`) VALUES ('42971cf33ad9f3de063faea9b9e7bd50', 'postinId', '45cc48e39fb855de5923cf5d735247c8', 'postin');
...
INSERT INTO `pcs_prc_role_function` (`id`, `role_id`, `function_id`, `bgroup`) VALUES ('7c91528eecdacf903f8ecd4abf1a3b23', 'postinId', '136c10de265146b40621babdb88fdcca', 'postin');
...
INSERT INTO `pcs_prc_role_function` (`id`, `role_id`, `function_id`, `bgroup`) VALUES ('8d88693f0b8905eda9b1fd2dc500d3e6', 'postinId', '4ab56fedc91484eb91d71a894b16349d', 'postin');
INSERT INTO `pcs_prc_role_function` (`id`, `role_id`, `function_id`, `bgroup`) VALUES ('8ec23e0d7461583dd8f79693a478d362', 'postinId', '2eca8165ccd6a0c33d1bd411662617ef', 'postin');
INSERT INTO `pcs_prc_role_function` (`id`, `role_id`, `function_id`, `bgroup`) VALUES ('a8fcb89998e8f7e6eb1a6aadd95b6ad3', 'postinId', '014418001c6decd391acf7aee55616c6', 'postin');
INSERT INTO `pcs_prc_role_function` (`id`, `role_id`, `function_id`, `bgroup`) VALUES ('b339dca335842c625d62dabc9b95c964', 'postinId', 'cdfc6bae3a807ec26c1ef0b934abcd49', 'postin');
INSERT INTO `pcs_prc_role_function` (`id`, `role_id`, `function_id`, `bgroup`) VALUES ('b6f258ea5853c4947bf16acd0556a75c', 'postinId', '12b085bb37913b5f7feb32da5ed260bb', 'postin');
...
INSERT INTO `pcs_prc_role_function` (`id`, `role_id`, `function_id`, `bgroup`) VALUES ('cf1b163a7839bbce2b6a8e55dfbfd063', 'postinId', '9edb86d608224be54bc463cbf8bf121b', 'postin');
