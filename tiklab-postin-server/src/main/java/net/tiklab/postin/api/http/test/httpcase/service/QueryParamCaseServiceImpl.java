...
import net.tiklab.postin.api.http.test.httpcase.dao.QueryParamCaseDao;
import net.tiklab.postin.api.http.test.httpcase.entity.QueryParamCaseEntity;

import net.tiklab.postin.api.http.test.httpcase.model.QueryParamCase;
import net.tiklab.postin.api.http.test.httpcase.model.QueryParamCaseQuery;
