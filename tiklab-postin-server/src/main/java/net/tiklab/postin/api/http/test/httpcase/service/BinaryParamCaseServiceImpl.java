...
import net.tiklab.postin.api.http.test.httpcase.dao.BinaryParamCaseDao;
import net.tiklab.postin.api.http.test.httpcase.entity.BinaryParamCaseEntity;
import net.tiklab.postin.api.http.test.httpcase.model.BinaryParamCase;
import net.tiklab.postin.api.http.test.httpcase.model.BinaryParamCaseQuery;
