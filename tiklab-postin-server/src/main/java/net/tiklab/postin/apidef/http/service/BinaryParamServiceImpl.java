...
import net.tiklab.postin.apidef.http.dao.BinaryParamDao;
import net.tiklab.postin.apidef.http.entity.BinaryParamEntity;
import net.tiklab.postin.apidef.http.model.BinaryParam;
import net.tiklab.postin.apidef.http.model.BinaryParamQuery;
