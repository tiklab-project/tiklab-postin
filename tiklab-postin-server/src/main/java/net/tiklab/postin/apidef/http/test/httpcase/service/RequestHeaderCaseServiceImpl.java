...
import net.tiklab.postin.apidef.http.test.httpcase.dao.RequestHeaderCaseDao;
import net.tiklab.postin.apidef.http.test.httpcase.entity.RequestHeaderCaseEntity;

import net.tiklab.postin.apidef.http.test.httpcase.model.RequestHeaderCase;
import net.tiklab.postin.apidef.http.test.httpcase.model.RequestHeaderCaseQuery;
