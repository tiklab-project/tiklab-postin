package net.tiklab.postin.apidef.http.test.httpinstance.service;

import net.tiklab.postin.apidef.http.test.httpinstance.dao.RequestInstanceDao;
import net.tiklab.postin.apidef.http.test.httpinstance.entity.RequestInstanceEntity;
import net.tiklab.postin.apidef.http.test.httpinstance.model.RequestInstance;
import net.tiklab.postin.apidef.http.test.httpinstance.model.RequestInstanceQuery;
