...
import net.tiklab.postin.apidef.http.test.httpcase.dao.JsonParamCaseDao;
import net.tiklab.postin.apidef.http.test.httpcase.entity.JsonParamCaseEntity;
import net.tiklab.postin.apidef.http.test.httpcase.model.JsonParamCase;
import net.tiklab.postin.apidef.http.test.httpcase.model.JsonParamCaseQuery;
