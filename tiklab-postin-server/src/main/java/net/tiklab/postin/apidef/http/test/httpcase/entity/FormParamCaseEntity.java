package net.tiklab.postin.apidef.http.test.httpcase.entity;
...
@Entity @Table(name="postin_http_case_request_form")
public class FormParamCaseEntity implements Serializable {
