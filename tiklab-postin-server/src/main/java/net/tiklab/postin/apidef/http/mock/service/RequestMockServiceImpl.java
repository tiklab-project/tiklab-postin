...
import net.tiklab.postin.apidef.http.mock.entity.RequestMockEntity;
import net.tiklab.postin.apidef.http.mock.model.RequestMock;
import net.tiklab.postin.apidef.http.mock.model.RequestMockQuery;
...
public class RequestMockServiceImpl implements RequestMockService {
    ...
    @Autowired
    net.tiklab.postin.apidef.http.mock.dao.RequestMockDao RequestMockDao;
