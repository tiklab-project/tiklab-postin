...
import net.tiklab.postin.apitest.http.httpcase.dao.RequestHeaderCaseDao;
import net.tiklab.postin.apitest.http.httpcase.entity.RequestHeaderCaseEntity;

import net.tiklab.postin.apitest.http.httpcase.model.RequestHeaderCase;
import net.tiklab.postin.apitest.http.httpcase.model.RequestHeaderCaseQuery;
