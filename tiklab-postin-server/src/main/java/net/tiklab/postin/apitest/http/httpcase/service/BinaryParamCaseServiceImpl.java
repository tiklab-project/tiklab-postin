...
import net.tiklab.postin.apitest.http.httpcase.dao.BinaryParamCaseDao;
import net.tiklab.postin.apitest.http.httpcase.entity.BinaryParamCaseEntity;
import net.tiklab.postin.apitest.http.httpcase.model.BinaryParamCase;
import net.tiklab.postin.apitest.http.httpcase.model.BinaryParamCaseQuery;
