package net.tiklab.postin.integration.search.controller;

import net.tiklab.postin.annotation.Api;
import net.tiklab.postin.annotation.ApiMethod;
import net.tiklab.postin.annotation.ApiParam;
import net.tiklab.postin.apidef.apix.model.Apix;
import net.tiklab.postin.integration.search.service.SearchService;
import net.tiklab.postin.workspace.model.Workspace;
import net.tiklab.core.Result;
import net.tiklab.core.exception.ApplicationException;
import net.tiklab.dss.common.model.*;
