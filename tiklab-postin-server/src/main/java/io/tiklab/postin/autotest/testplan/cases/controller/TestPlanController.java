package io.tiklab.postin.autotest.testplan.cases.controller;
...
public class TestPlanController {
     ...
     * @pi.param: model=io.tiklab.postin.autotest.testplan.cases.model.TestPlan
     */
...
//    @ApiMethod(name = "findAllTestPlan",desc = "查询所有测试计划")
     ...
     * @pi.methodType:post
     * @pi.request-type:json
     * @pi.param: model=io.tiklab.postin.autotest.testplan.cases.model.TestPlanQuery
     */
