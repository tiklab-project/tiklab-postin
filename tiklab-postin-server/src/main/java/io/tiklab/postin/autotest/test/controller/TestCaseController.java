package io.tiklab.postin.autotest.test.controller;
...
//    @ApiParam(name = "workspaceId",desc = "workspaceId",required = true)
    public Result<HashMap<String, Integer>> findDiffTypeCaseNum(@NotNull String workspaceId){
        HashMap<String, Integer> diffTypeCaseNum = testCaseService.findDiffTypeCaseNum(workspaceId);
