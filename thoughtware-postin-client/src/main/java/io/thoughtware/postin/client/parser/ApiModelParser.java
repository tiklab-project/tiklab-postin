package io.thoughtware.postin.client.parser;
...
public class ApiModelParser {
    ...
    public List<ApiPropertyMeta> parseProperties(Type modelType, Type actualType){
        ...
        try {
            ...
            String errorMsg = String.format("parse io.thoughtware.postin.test.model failed,modelType:%s",modelType);
        ...
        for (Field field:fields){
            ...
            try {
                ...
                String errorMsg = String.format("parse io.thoughtware.postin.test.model property failed,modelType:%s,fieldType:%s",modelType,field.getType());
                throw new SystemException(errorMsg,e);
            }
