...
import io.thoughtware.postin.client.model.ApiParamMeta;
import io.thoughtware.postin.client.parser.ApiParser;
import io.thoughtware.postin.client.model.ApiMethodMeta;
    ...
    private JSONObject loopModel(JSONArray modelData){
        ...
        for (Object jsonObject:modelData){
            ...
            if (dataType.contains("int")) {
                ...
                if(modelJson.getString("io.thoughtware.postin.test.model")!=null){
                    String string = modelJson.getString("io.thoughtware.postin.test.model");
